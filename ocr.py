...
class OCRHandler:
    ...
    def accumulate_questions(
        ...
        try:
            ...
            questions_data = get_single_question_data(
                extracted_text
            )

            question_data["Question"].extend(
                questions_data["Question"]
            )

            question_data["Options"].extend(
            ...
            print(
                f"Error accumulating questions: {e}"
            )
